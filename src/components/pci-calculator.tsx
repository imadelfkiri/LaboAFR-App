    ...
    <Card className="w-full max-w-5xl shadow-lg bg-white">
      <CardHeader className="text-center">
        <div className="inline-flex items-center justify-center gap-3">
          ...
          <CardTitle className="text-3xl font-bold tracking-tight">Calculateur de PCI Brut</CardTitle>
        </div>
      </CardHeader>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className="space-y-8 pt-4">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Données Analytiques</h3>
            ...
            <section>
                <Card className="bg-gray-50 border-dashed">
                    <CardHeader>
                        <CardTitle className="text-center text-lg font-semibold text-gray-600">PCI sur Brut (kcal/kg)</CardTitle>
                    </CardHeader>
