...
export function SidebarNav({ userRole, isOpen, setIsOpen, onLogout }: SidebarNavProps) {
  ...
  return (
    <motion.aside
      ...
      className="h-screen bg-card/95 backdrop-blur-md border-r border-white/5 text-gray-300 flex flex-col shadow-2xl fixed z-50"
    >
      {/* HEADER */}
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-primary/10 text-primary font-medium border-l-4 border-primary shadow-sm"
                    : "hover:bg-white/5 hover:text-primary transition-colors border-l-4 border-transparent"
                )}
              >
                <motion.div
