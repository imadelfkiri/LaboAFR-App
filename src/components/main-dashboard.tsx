        ...
        >
            <div className="flex flex-col md:flex-row justify-between md:items-end gap-4 pb-2">
                <div>
                    <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-primary/80">Tableau de Bord</span>
                    </h1>
                    <p className="text-muted-foreground mt-2 font-medium">
                        Suivi des performances énergétiques et analyses AFR
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                {mixtureIndicators ? (
                    ...
                    <Card className="glass-panel border-0 transition-all hover:shadow-2xl hover:bg-card/70">
                        <CardHeader>
                            <CardTitle className="text-lg flex items-center gap-2 text-foreground">
                                <Recycle className="text-primary h-5 w-5 animate-pulse" />
            ...
            <Card className="glass-panel border-0 transition-all hover:shadow-soft">
                <CardHeader>
                    <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-3">
                        ...
                        <div className="flex items-center gap-4">
                            <Select value={indicator} onValueChange={setIndicator}>
                                <SelectTrigger className="w-[180px] bg-card/50 border-white/5 text-foreground focus:ring-primary/50">
                            ...
                            <Popover open={openCalendar} onOpenChange={setOpenCalendar}>
                                <PopoverTrigger asChild>
                                    <Button
                                        variant="outline"
                                        className="bg-card/50 border-white/5 text-foreground hover:bg-primary/20 hover:text-primary transition-colors"
                                    >
                                ...
                                <PopoverContent className="p-0 bg-card border-white/10">
                                    <Calendar
                                        mode="range"
                                        selected={dateRange}
